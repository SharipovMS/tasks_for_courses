...
class ContactHelper:
    ...
    def get_contact_list(self):
        if self.cont_cache is None:
            ...
            for row in wd.find_elements_by_name("entry"):
                ...
                self.cont_cache.append(Contact(firstname=firstname, lastname=lastname, address=address, id=id,
    ...
    def get_contact_info_from_edit_page(self, index):
        ...
        return Contact(firstname=firstname, lastname=lastname, id=id,
                       workphone=workphone, homephone=homephone, mobilephone=mobilephone, secondaryphone=secondaryphone,
