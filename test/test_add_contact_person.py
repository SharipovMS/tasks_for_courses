...
def test_add_create_contact(app): #тестовый метод
    app.session.login()
    app.group.create_contact(class_for_test_create_contact(firstname="Marat", second_name="Sharipov", lastname="Sericbaevich", nickname="murena", company="quality-lab", address="Moscow",
...
def test_add_create_contact_empty(app): #тестовый метод
    app.session.login()
    app.group.create_contact(class_for_test_create_contact(firstname="", second_name="", lastname="", nickname="", company="", address="",
